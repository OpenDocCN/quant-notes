# 14天拿下Python金融量化，股票分析、数据清洗，可视化 - P38：44 双均线分析作业1 - 路飞学城Alex小助理 - BV1HAyPYYEAr
...
他最后给你返回的是一个rolling对象，跟那个RESEMPLE一样，那我要求平均怎么写点min，你看四个NN20。0674，看看这个值是啊，那个值没有了，跟那个跟跟刚才咱们自己算的那个值是一样的。
