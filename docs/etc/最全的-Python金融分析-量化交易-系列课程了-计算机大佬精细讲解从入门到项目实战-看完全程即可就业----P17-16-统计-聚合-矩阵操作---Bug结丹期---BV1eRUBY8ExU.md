# 强推！这可能是B站最全的【Python金融分析+量化交易】系列课程了，计算机大佬精细讲解从入门到项目实战，看完全程即可就业！ - P17：16 统计&聚合&矩阵操作 - Bug结丹期 - BV1eRUBY8ExU
...
我们进行积累之后返回的是一个新的数组吧，对吧好，我们叫做error杠三，OK吧，那现在我们就来把PRT点m show，进行error杠三的一个显示走，你显示的是三张图片拼一起了对吧。
