# 【量化交易完全可自学教程】2024B站最完整的Python金融分析与量化交易实战教程分享！知名博士通俗易懂的解释，学量化交易真的不难！ - P70：8. 7.9.2-买点与卖点可视化分析P9 - AI知识库 - BV1YT42117B5
...
这里只有几个股票是吧，咱就拿这个苹果这个股票来当例子，给大家做这样一个实验，然后这个info咱也不用去看了。
