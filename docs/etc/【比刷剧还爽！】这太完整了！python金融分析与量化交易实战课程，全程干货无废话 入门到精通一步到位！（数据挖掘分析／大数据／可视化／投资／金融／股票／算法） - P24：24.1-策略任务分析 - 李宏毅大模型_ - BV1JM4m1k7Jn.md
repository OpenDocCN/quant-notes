# 【比刷剧还爽！】这太完整了！python金融分析与量化交易实战课程，全程干货无废话 入门到精通一步到位！（数据挖掘分析／大数据／可视化／投资／金融／股票／算法） - P24：24.1-策略任务分析 - 李宏毅大模型_ - BV1JM4m1k7Jn
...
其他方面特征咱们可能一会只选择某一个啊，咱不举那么多太多的例子，那选择一个特征，我看看这个特征啊，比如说我说看一下吧，呃当前每个股票，然后他的一些财务数据，财务数据当中呢，比如说有一个盈利吧。
