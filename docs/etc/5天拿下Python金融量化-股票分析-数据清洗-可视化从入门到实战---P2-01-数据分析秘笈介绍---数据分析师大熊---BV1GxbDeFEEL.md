# 5天拿下Python金融量化，股票分析、数据清洗，可视化从入门到实战 - P2：01 数据分析秘笈介绍 - 数据分析师大熊 - BV1GxbDeFEEL
...
哪些方方面面，对不对，OK吧，好，这块呢是对我们数据分析这样的一个专业技能。
...
OK吧，所以说咱们整个的课程当中，第一是有基础内容的一个讲解跟学习，那基础内容咱们学会之后，一定是基于咱们的实战项目去巩固，咱们的基础内容，是不是，并且让也让大家能够很明确的感受到。
