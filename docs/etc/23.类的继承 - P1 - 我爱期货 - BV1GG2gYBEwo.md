...
这段滚到下面来写，这样就会方便一点，class stock trade data啊，然后呃，这什么意思，Class stop trade data，我又献了一个新的类。
...
我们可以看到他能正确的打印结果啊，这个大大的出来，所以呃当然这这看着有点不舒服，大家看到600361百首啊，什么原因呢，应该是在这啊，我漏了一个空格，刚刚换行，他说把它给删了啊，重新把空格加上啊。
...
这我们不讲的正规点扩展子类方法，那么calculate catch change，这么一个方法是我在stock trade data类下面定义的，上面trade data类是没有的。
...
然后呢我们可能诶到这儿我们又想要去实现啊，一个新的这个期货的数据X就我不在future trade data，而是一个呃，不好意思，不在是stock trade data。

而是一个future trad，那此时我们知道future stratea有个额外的问题，它还多了一个啊这个保证金的概念，保证金是有一个保证金率的，叫做margin rate啊，我们先把它设为0。0。
...
他又把这个啊我们的这个啊这个这个trait，因为我们知道它引内函数要用的字段，主要是这么五个啊，Symbol，Symbol deterdirection，Price volume size。
...
我们这个要用的futures trade data这么一个类，我们也同样来看看它的效果啊，这个然后直接就，扩展子类数据，Future trade，啊他可能是比如说呃我们还用F2010啊，这个时间改一下。

一分钟后还是买啊，然后成交价格可能4000啊，成交数量我买了一手，但合约成数比较大，是300啊，然后这个时候呢我们来打印一下，看看它的结果是什么，期货成交单，这样好，我们来看一下结果是怎样的。
...
所以刚刚我就是相当于来回摁了两下啊，这样我再来运行它，大家可以看到这里，我们计算期货成交的现金变化啊，哦不好意思，我这打错了，然后保证金率呢我就传个0。15啊，就15%啊，然后我们这边打打一下。
...
U r u sb，然后呢就一啊五六这个9。45分，外汇啊，一般我们成交金额会比较大一点，比如说我成交来个1万啊，因为汇率的波动，其实相比起股票和期货来说要小很多，所以一般他的交易金额比较大。
