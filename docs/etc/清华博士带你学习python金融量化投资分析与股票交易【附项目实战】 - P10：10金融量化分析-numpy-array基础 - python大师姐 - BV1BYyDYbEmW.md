# 清华博士带你学习python金融量化投资分析与股票交易【附项目实战】 - P10：10金融量化分析-numpy-array基础 - python大师姐 - BV1BYyDYbEmW
...
不知道uniform函数是随机生成，不列一个浮点数嗯，就是100~230围这边负电荷的浮点数嗯，然后总体这是一个什么列表方程式啊，唉生成了行了50个数，50个字就是我模拟相当于50家公司啊。
