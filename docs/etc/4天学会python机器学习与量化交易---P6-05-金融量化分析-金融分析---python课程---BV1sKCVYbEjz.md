# 4天学会python机器学习与量化交易 - P6：05 金融量化分析-金融分析 - python课程 - BV1sKCVYbEjz
...
然后从这个价开始静开始波动啊，最后3年截止那个价叫做收盘价啊，如果开盘价比收盘价低，那就叫做低开高走，对是吧，就是涨了对，就是今天的价格是涨了，那这个线就要用阳线来表扬啊，如果开盘价比低。
